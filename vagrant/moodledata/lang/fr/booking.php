...
/**
 * Strings for component 'booking', language 'fr', branch 'MOODLE_29_STABLE'
 *
 * @package   booking
...
$string['additionalfields'] = 'Champs additionnels';
...
$string['confirmactivitycompletion'] = 'Confirmer l\'achèvement de l\'activité';
...
$string['deletebooking'] = 'Souhaitez-vous vraiment vous désinscrire du cours suivant? <br /><br /> <b>{$a} </b>';
...
$string['havetologin'] = 'Vous devez vous identifier avant de pouvoir soumettre votre réservation';
...
$string['searchFinished'] = 'Cours achevé';
$string['searchName'] = 'Nom';
$string['searchSurname'] = 'Prénom';
...
$string['showmybookings'] = 'Ne montrer que mes réservations';
...
$string['subscribeuser'] = 'Voulez-vous vraiment d\'inscrire les utilisateurs au cours suivant';
$string['sucesfulldeleted'] = 'La catégorie a été supprimé avec succès!';
$string['sucesfulldeletedinstitution'] = 'L\'institution a été supprimé avec succès';
$string['tagsucesfullysaved'] = 'Balise a été enregistrée avec succès.';
...
$string['userrssucesfullenroled'] = 'Tous les utilisateurs ont été inscrits avec succès!';
$string['users'] = 'Gérer les réponses';
$string['usersOnList'] = 'Utilisateurs sur la liste';
$string['userssucesfullybooked'] = 'Tous les utilisateurs on été inscrits avec succès sur une autre liste de réservation';
