...
$subnavheader = $PAGE->blocks->region_has_content('sub-nav-header', $OUTPUT);
                ...
                echo (!$left) ? ' pull-right' : ' pull-left'; ?>">
                    <?php if (!$haslogo) { ?>
                        <a class="textlogo" href="<?php echo preg_replace("(https?:)", "", $CFG->wwwroot); ?>">
                            <i id="headerlogo" class="fa fa-<?php echo theme_solerni_get_setting('siteicon'); ?>"></i>
                            <?php echo theme_solerni_get_title('header'); ?>
                        </a>
                    <?php } else { ?>
                ...
                <div class="icon-collapse collapse pull-<?php echo ($left) ? 'right' : 'left'; ?>">
                    ...
                    if ($hassocialnetworks) {
                        ...
                        <div class="pull-<?php echo ($left) ? 'right' : 'left'; ?>" id="socialnetworks">
                            <p id="socialheading"><?php echo get_string('socialnetworks', 'theme_solerni') ?></p>
                    ...
                    if ($hasmobileapps) {
                        ...
                        <div class="pull-<?php echo ($left) ? 'right' : 'left'; ?>" id="mobileapps">
                            <p id="socialheading"><?php echo get_string('mobileappsheading', 'theme_solerni') ?></p>
                            <ul class="socials unstyled">
                                <?php
            ...
            <div class="container-fluid navbar-inner">
                <div class="row-fluid">
                    <div class="custommenus pull-<?php echo ($left) ? 'left' : 'right'; ?>">
                        ...
                        <?php echo theme_solerni_get_title('navbar'); ?>
