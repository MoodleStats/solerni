...
require_once(dirname(__FILE__) . '/lintchecker.php');
require_once(dirname(__FILE__) . '/codegrepper.php');
require_once(dirname(__FILE__) . '/utils/utilslib.php');
...
function run_codechecker($githash = null) {
    ...
    $dirroot = dirname(__FILE__) . '/..'; // . '/vagrant/solerni';
