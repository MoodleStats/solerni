...
if (file_exists("$CFG->dirroot/course/format/noticebd/renderer.php")) {
    ...
    class theme_solerni_format_noticebd_renderer extends format_noticebd_renderer
    {
        ...
        {
            return theme_solerni_get_nav_links($course, $sections, $sectionno);
        }
        ...
        {
            return theme_solerni_print_single_section_page($this, $this->courserenderer, $course, $sections, $mods, $modnames, $modnamesused, $displaysection);
        }
    }
}