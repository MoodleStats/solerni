...
/**
 * Strings for component 'dialogue', language 'fr', branch 'MOODLE_29_STABLE'
 *
 * @package   dialogue
...
$string['conversationcloseconfirm'] = 'Êtes-vous sûr de vouloir fermer la conversation {$a} ?';
$string['conversationclosed'] = 'La conversation {$a} a été fermée';
$string['conversationdeleteconfirm'] = 'Êtes vous sûr de vouloir supprimer la conversation {$a} ? Cette action est définitive';
