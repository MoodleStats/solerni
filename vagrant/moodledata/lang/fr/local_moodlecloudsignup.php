...
/**
 * Strings for component 'local_moodlecloudsignup', language 'fr', branch 'MOODLE_29_STABLE'
 *
...
$string['brand:logout'] = 'Déconnexion';
...
$string['homepage:body.intro'] = 'Hébergement Moodle gratuit, offert par les créateurs de Moodle.';
$string['homepage:body.title'] = 'MoodleCloud';
$string['homepage:general.servicestatus'] = 'État du service';
$string['homepage:infoboxes.footer'] = 'Vous êtes motivé et fin prêt pour construire votre site MoodleCloud ? Nous avons préparé du matériel pour vous aider, que vous verrez en accédant à votre plateforme. vous pouvez également consulter notre chaîne Youtube pour des vidéos pratiques et pour en savoir davantage sur le potentiel de Moodle, ainsi que pour apprendre comment des enseignants du monde entier créent des choses incroyables avec leurs plateformes Moodle.';
$string['homepage:infoboxes.infobox1.intro'] = 'MoodleCloud est une nouvelle solution d\'hébergement offerte directement par les créateurs de Moodle, qui permet à tous d\'obtenir un site Moodle en quelques minutes. MoodleCloud met à votre disposition la version la plus récente de Moodle, un système de gestion de l\'apprentissage reconnu mondialement.';
$string['homepage:infoboxes.infobox1.title'] = 'La dernière version de Moodle';
$string['homepage:infoboxes.infobox2.intro'] = 'Ajoutez une session de téléconférence à votre MoodleCloud, gracieusement offerte par nos amis de BigBlueButton. Intégrée gratuitement à tous les sites MoodleCloud, cette solution libre inclut la téléconférence, avec la vidéo, le son, un tableau blanc et le partage d\'écran.';
$string['homepage:infoboxes.infobox2.title'] = 'Téléconférence BigBlueButton';
$string['homepage:infoboxes.infobox3.intro'] = 'Les sites MoodleCloud gratuits diffèrent un peu de Moodle : ils sont un peu moins flexibles, affichent une publicité au bas des pages et aucun support technique n\'est offert. Si vous avez besoin d\'aide pour utiliser Moodle, vous devrez contacter un Moodle Partner ou utiliser les ressources offertes par la communauté sur moodle.org.';
$string['homepage:infoboxes.infobox3.title'] = 'Support communautaire';
$string['homepage:infoboxes.infobox4.intro'] = 'Tous les administrateurs de sites MoodleCloud ont accès à leur portail, où ils peuvent surveiller l\'utilisation et les statistiques de leur site ainsi que le supprimer au besoin (mais qui le voudrait ?). Vous pouvez ainsi suivre la croissance de votre site, des cours qui y sont offerts et des étudiants qui le consultent.';
$string['homepage:infoboxes.infobox4.title'] = 'Suivi de l\'utilisation et statistiques';
$string['homepage:infoboxes.infobox5.intro'] = 'Accédez à votre matériel d\'apprentissage à distance avec MoodleCloud. Notre application Moodle Mobile officielle se connecte à votre MoodleCloud, sans aucune intervention d\'un administrateur. Disponible sur iOS, Android et Windows.';
$string['homepage:infoboxes.infobox5.title'] = 'Application mobile';
$string['homepage:infoboxes.infobox6.intro'] = 'MoodleCloud est particulièrement approprié pour les enseignants n\'ayant pas beaucoup de ressources et qui veulent utiliser Moodle pour un cours, mais est également offert à quiconque souhaite essayer Moodle dans un contexte réel d\'enseignement, que ça soit dans une petite école, une PME ou un département gouvernemental.';
$string['homepage:infoboxes.infobox6.title'] = 'Enseignants';
$string['homepage:infoboxes.intro'] = 'Votre propre site MoodleCloud, gratuitement : pas de période d\'essai, pas de carte de crédit, pas de problème.';
$string['homepage:infoboxes.title'] = 'Vous souhaitez que la technique ne gêne pas l\'enseignement ?';
$string['homepage:login.intro'] = 'Si vous possédez déjà un compte MoodleCloud, vous pouvez accéder à votre portail ici :';
$string['homepage:login.title'] = 'Connexion au portail';
$string['homepage:page.title'] = 'MoodleCloud : hébergement Moodle gratuit, par les créateurs de Moodle.';
$string['homepage:signup.info.sizelimit'] = '200 Mo d\'espace de stockage';
$string['homepage:signup.info.title'] = 'Les sites Moodle gratuits sont actuellement limités à :';
$string['homepage:signup.info.userlimit'] = '50 comptes utilisateurs actifs';
$string['homepage:signup.intro'] = 'Créez dès aujourd\'hui votre site Moodle gratuit dans MoodleCloud';
$string['homepage:signup.links.moreinfo.title'] = 'J\'aimerais en savoir plus avant de m\'inscrire';
$string['homepage:signup.links.signup.title'] = 'Inscription';
$string['homepage:signup.title'] = 'Inscription';
$string['langconfig:direction'] = 'ltr';
$string['langconfig:langname'] = 'Anglais';
...
$string['login:security.login.username'] = 'Nom MoodleCloud';
$string['login:security.login.username_placeholder'] = 'monsite.moodlecloud.com';
...
$string['portal:list.body.title'] = 'Portail MoodleCloud';
...
$string['portal:view.danger.modal.buttons.cancel'] = 'Non ! Ça n\'était qu\'un gros malentendu !';
$string['portal:view.danger.modal.buttons.continue'] = 'Oui, je souhaite réellement supprimer mon site MoodleCloud.';
...
$string['regions:ap-southeast-2'] = 'Australie';
$string['regions:eu-west-1'] = 'Irlande';
$string['regions:us-west-2'] = 'États-Unis';
$string['signup:authcode.body.lead'] = 'Nous venons de vous envoyer un SMS contenant un code de vérification. Veuillez le saisir ci-dessous. Si vous n\'avez pas reçu le SMS, veuillez consulter les  <a href="https://moodle.com/cloud/faq/#sms" target="_blank">FAQs</a> pour connaître les causes possibles.';
$string['signup:authcode.body.links.startover'] = 'Vous voulez recommencer ?  <a href="%link%">Repartons depuis le début</a>.';
$string['signup:authcode.body.title'] = 'Confirmez votre numéro de téléphone.';
$string['signup:authcode.form.fields.authcode'] = 'Code de vérification';
$string['signup:authcode.form.fields.continue'] = 'Continuer';
...
$string['signup:page.breadcrumb'] = 'Enregistrement';
$string['signup:page.title'] = 'MoodleCloud : enregistrez-vous pour avoir votre site Moodle gratuit';
$string['signup:password.body.restoredpassword'] = 'Bonne nouvelle ! Nous avons un mot de passe pour votre compte MoodleCloud. Si vous souhaitez continuer à utiliser ce mot de passe, vous pouvez passer cette section.';
$string['signup:password.body.title'] = 'Pour terminer, choisissez votre mot de passe !';
$string['signup:password.form.fields.password'] = 'Nouveau mot de passe';
$string['signup:password.form.fields.password_confirmation'] = 'Et une deuxième fois, pour être bien certain';
$string['signup:password.form.fields.save'] = 'Sauvegarder le mot de passe';
...
$string['signup:personal.form.fields.continue'] = 'Continuer';
...
$string['signup:reserve.body.title'] = 'Vous n\'êtes plus qu\'à quelques clics de votre site MoodleCloud !';
$string['signup:reserve.form.fields.continue'] = 'Obtenir mon site';
...
$string['validators:signup.email.mustexist'] = 'Veuillez saisir votre adresse de courriel';
...
$string['validators:site.email.mustexist'] = 'Vous devez spécifier votre adresse de courriel';
$string['validators:site.email.validformat'] = 'Veuillez spécifier votre adresse de courriel dans un format valide';
$string['validators:site.firstname.mustexist'] = 'Vous devez spécifier votre prénom';
$string['validators:site.lastname.mustexist'] = 'Vous devez spécifier votre nom';
