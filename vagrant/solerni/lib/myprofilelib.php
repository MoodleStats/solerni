...
function core_myprofile_navigation(core_user\output\myprofile\tree $tree, $user, $iscurrentuser, $course) {
    ...
    // Orange - 2016.06.02 - should not test on site:viewuseridentity capability.
    // because capability already tested below. Link to MDL-35780/50534.
    $identityfields = array_flip(explode(',', $CFG->showuseridentity));
    ...
    if ($user->icq && !isset($hiddenfields['icqnumber'])) {
        ...
        // Orange - 2016.06.01 - Bad URL link, not used.
        $statusicon = "";
