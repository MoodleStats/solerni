...
if (theme_solerni_get_setting('iphoneicon')) {
    $iphoneicon = theme_solerni_get_setting('iphoneicon');
} else {
    $iphoneicon = $OUTPUT->pix_url('homeicon/iphone', 'theme');
}
if (theme_solerni_get_setting('ipadicon')) {
    $ipadicon = theme_solerni_get_setting('ipadicon');
} else {
    $ipadicon = $OUTPUT->pix_url('homeicon/ipad', 'theme');
}
if (theme_solerni_get_setting('iphoneretinaicon')) {
    $iphoneretinaicon = theme_solerni_get_setting('iphoneretinaicon');
} else {
    $iphoneretinaicon = $OUTPUT->pix_url('homeicon/iphone_retina', 'theme');
}
if (theme_solerni_get_setting('ipadretinaicon')) {
    $ipadretinaicon = theme_solerni_get_setting('ipadretinaicon');
} else {
