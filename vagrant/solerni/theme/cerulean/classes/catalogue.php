...
class catalogue {
    ...
    public static function cerulean_catalogue_get_customer_infos ($catid) {
        global $CFG;
     ...
     *
     */
    public static function cerulean_catalogue_get_course_infos ($course) {
        global $DB;
