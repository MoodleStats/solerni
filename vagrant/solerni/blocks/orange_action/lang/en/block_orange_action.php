...
$string['coursetopushdesc'] = 'Select the course which will be push on user dashboard (Only non closed MOOCs are in the list).';
$string['eventtopush'] = 'Event to push';
$string['eventtopushdesc'] = 'Select the event which will be push on user dashboard (Only not passed events are on the list).';
