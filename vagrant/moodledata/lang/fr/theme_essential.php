...
/**
 * Strings for component 'theme_essential', language 'fr', branch 'MOODLE_29_STABLE'
 *
...
$string['alertinfodesc'] = 'Entrez les paramètres pour votre alerte.';
...
$string['analyticsuseuseriddesc'] = 'Autoriser l\'utilisation de l\'ID utilisateur dans le suivi.';
...
$string['credit'] = 'Le thème {$a->name} pour Moodle est développé par ';
...
$string['logoheightdesc'] = 'La hauteur de l\'image du logo. Peut être spécifiée en px ou em.';
...
$string['styleguidedesc'] = 'Code de documentation originale \'{$a->origcodelicenseurl}\' sous licence. Code additionnel \'{$a->thiscodelicenseurl}\' sous licence, which is a \'{$a->compatible}\' license. Contenu \'{$a->contentlicenseurl}\' sous licence. La mise en forme de cette documentation a été produite par Moodle avec l\'ajout d\'icônes FontAwesome où nécessaire. Des paramètres CSS additionnels se trouvent dans le fichier \'essential_admin_setting_styleguide.php\' avec le commentaire \'// Beyond docs.css.\'. La section \'{$a->globalsettings}\' a été retirée.';
$string['styleguidesub'] = 'Guide du style Bootstrap V2.3.2';
