...
/* Core */
$string['configtitle'] = 'Solerni V2';
$string['pluginname'] = 'Solerni V2';
$string['choosereadme'] = 'Solerni V2 custom theme';
...
// Readme.
$string['readme_title'] = 'Solerni V2 read-me';
$string['readme_desc'] = 'Please {$a->url} containing more information about the Solerni V2 theme.';
