...
/**
 * Strings for component 'assignsubmission_onlineaudio', language 'fr', branch 'MOODLE_29_STABLE'
 *
...
$string['confirmdeletefile'] = 'Êtes-vous sûr de vouloir supprimer le fichier <strong>{$a}</strong>?';
