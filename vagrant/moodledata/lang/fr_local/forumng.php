...
$string['event:mailsent'] = 'Email envoyé';
...
$string['configreplytouser'] = 'Lorsqu\'un message est envoyé par email, doit-il contenir l\'adresse email de son auteur, afin que le destinataire puisse l\'atteindre personnellement. Même lorsque cette option est activée, les utilisateurs peuvent choisir dans leur profil de garder leur adresse secrète.';
...
$string['subscribestart'] = 'M\'envoyer des copies par email des messages de ce forum';
$string['subscribestop'] = 'Je ne veux pas de copies par email des messages de ce forum';
...
$string['noguestsubscribe'] = 'Désolé, les visiteurs ne sont pas autorisés à s\'abonner pour recevoir les messages des forums par email.';
...
$string['forumng:forwardposts'] = 'Transférer le(s) message(s) par email';
...
$string['configsubscription'] = 'Configuration des options de notification par email sur tous les forums du site.';
...
$string['usebcc']='Envoyer un email en copie invisible (\'Cci\')';
$string['configusebcc']='Laisser cette valeur à 0 pour utiliser les réglages par défaut de la messagerie Moodle (plus sûr).<br>Indiquez un chiffre (par exemple 50) pour regrouper les messages du forum avec l\'option \'copie invisible\' (\'Cci\') pour que Moodle envoie un email unique depuis votre serveur de messagerie à de nombreux utilisateur.<br>Au lieu d\'envoyer 50 fois 1 message aux 50 personnes, cela envoie 1 message aux 50 personnes en copie invisible.';
$string['donotmailafter']='Ne pas envoyer de email après (heure(s))';
$string['configdonotmailafter']='Pour éviter l\'envoi d\'un nombre trop important de messages si le cron de maintenance n\'a pas été exécuté récemment, le forum n\'enverra pas les emails correspondants aux messages plus vieux que ce nombre d\'heures.';
$string['re']='Re: {$a}';
...
$string['subscribestate_partiallysubscribed'] = 'Vous recevez des messages provenant de certaines discussions de ce forum par email à {$a}.';
$string['subscribestate_partiallysubscribed_thisgroup'] = 'Vous recevez des messages provenant de certaines discussions de ce groupe  par email à {$a}.';
$string['subscribestate_groups_partiallysubscribed'] = 'Vous recevez des messages provenant de certains groupes de ce forum par email à {$a}.';
$string['subscribestate_subscribed'] = 'Vous recevez des messages de ce forum par email à {$a}.';
$string['subscribestate_subscribed_thisgroup'] = 'Vous recevez des messages de ce groupe par email à {$a}.';
$string['subscribestate_subscribed_notinallgroup'] = 'Cliquer sur &lsquo;Désabonnement&rsquo; pour se désabonner de ce forum.';
$string['subscribestate_unsubscribed'] = 'Vous ne recevez pas les messages de ce forum par email. Si vous le souhaitez, cliquez sur &lsquo;S\'abonner&rsquo;.';
$string['subscribestate_unsubscribed_thisgroup'] = 'Vous ne recevez pas les messages de ce groupe par email. Si vous le souhaitez, cliquez sur &lsquo;S\'abonner&rsquo;';
$string['subscribestate_not_permitted'] = 'Ce forum ne permet pas l\'abonnement par email.';
$string['subscribestate_forced'] = '(Le désabonnement n\'est pas possible.)';
$string['subscribestate_no_access'] = 'Vous n\'avez pas la possibilité de vous abonner par email à ce forum.';
$string['subscribestate_discussionsubscribed'] = 'Vous recevez tous les messages de cette discussion par email à {$a}.';
$string['subscribestate_discussionunsubscribed'] = 'Vous ne recevez pas les messages de cette discussion par email. Si vous le souhaitez, cliquez sur &lsquo;S\'abonner&rsquo;.';
...
$string['deleteandemail'] = 'Supprimer et notifier l\'auteur par email';
...
$string['emailerror'] = 'Il y a eu une erreur lors de l\envoi de l\'email';
...
$string['forumng:mailnow'] = 'Notifier par email avant la fin du délai d\'édition';
...
$string['error_forwardemail'] = 'Il y a eu une erreur lors de l\'envoi de l\'email à  <strong>{$a}</strong>. L\'email n\'a pu être envoyé.';
$string['alert_link'] = 'Signaler';
$string['alert_linktitle'] = 'Marquer ce message comme inacceptable';
$string['reportunacceptable'] = 'Email de contact pour le signalement de messages offensants';
$string['reportingemail'] = 'Email de contact pour le signalement de messages offensants';
...
$string['alert_note'] = 'Note : Cet email a également été envoyé à {$a}';
...
$string['mailnow_help'] = 'Envoyer votre message par email aux abonnés plus rapidement.

Sauf si vous choisissez cette option, le système attend pendant un certain temps avant d\'envoyer le message de telle sorte que toutes les modifications que vous pourriez faire peuvent être inclus dans l\'email.';
...
$string['extra_emails'] = 'Adresse email des autres destinataires';
...
$string['emailauthor'] = 'Auteur de \'email';
...
$string['emailauthor_help'] = 'Envoyer un email à l’auteur du message pour l\'informer que vous avez modifié son message';
...
$string['forumngcrontaskemails'] = 'Tâche d\'envoi d\'email de Forumng';
$string['forumngcrontaskdaily'] = 'Tâche de maintenance quotidienne de Forumng';
$string['forumngcrontaskdigest'] = 'Tâche de génération de l\'email de synthèse de Forumng';
