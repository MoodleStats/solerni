...
$string['enablebadgesdesc'] = 'Afficher un lien vers les badges de l\'utilisateur';
...
$string['enablemydesc'] = 'Afficher un lien vers Ma page';
$string['enableprivatefiles'] = 'Fichiers personnels';
$string['enableprivatefilesdesc'] = 'Afficher un lien vers les fichiers personnels des utilisateurs';
...
$string['transparencydesc'] = 'Vous voulez voir à travers de votre image de fond ? Ce paramètre modifie la transparence du contenu et des blocs Moodle';
