            ...
            foreach ($details as $key => $detailsbytype) {
                foreach ($detailsbytype as $detail) {
                    ...
                    if ($detail->modname == 'quiz') {
                        if ($detail->quizuserattempts <= 1) {
                            $output .= $detail->quizuserattempts . ' ' . get_string('attempt', 'block_orange_progressbar');
                        } else {
                            $output .= $detail->quizuserattempts . ' ' . get_string('attempts', 'block_orange_progressbar');
                        }
