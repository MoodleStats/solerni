...
$string['forward_preface'] = '<b>Bonjour,</p><p><span class="txt18BNoir">{$a->name}</span> a souhaité vous transférer ces messages issus de la discussion "{$a->discussion}", disponible sur le forum de <span class="txt18BNoir">{$a->fullname}</span>.</p>';
$string['forward_done'] = 'L\'e-mail a bien été envoyé.';
...
$string['pluginname'] = 'Transfert par e-mail';
$string['event:discussionforwarded'] = 'Transfert de discussion';