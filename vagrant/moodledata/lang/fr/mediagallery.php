...
/**
 * Strings for component 'mediagallery', language 'fr', branch 'MOODLE_29_STABLE'
 *
...
$string['removecollectionconfirm'] = 'Souhaitez-vous vraiment supprimer le lien vers cette collection ?';
$string['removegalleryconfirm'] = 'Souhaitez-vous vraiment supprimer le lien vers cette galerie ?';
$string['removeitemconfirm'] = 'Souhaitez-vous vraiment supprimer le lien vers cet élément  ?';
