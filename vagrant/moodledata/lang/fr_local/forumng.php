...
/**
 * Lang strings.
 * Traduction par Pascal Maury, Luiggi Sansonetti et Pascal Le Merrer (Orange Labs)
 * @package mod
 * @subpackage forumng
 * @copyright 2011 The Open University
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
$string['event:discussioncreated'] = 'Discussion ajoutée';
$string['event:discussiondeleted'] = 'Discussion effacée';
$string['event:discussionlocked'] = 'Discussion verrouillée';
$string['event:discussionmerged'] = 'Discussion fusionnée';
$string['event:discussionpermdeleted'] = 'Discussion définitivement effacée';
$string['event:discussionundeleted'] = 'Discussion restaurée';
$string['event:discussionunlocked'] = 'Discussion déverrouillée';
$string['event:discussionviewed'] = 'Discussion affichée';
$string['event:mailsent'] = 'E-mail envoyé';
$string['event:postcreated'] = 'Message créé';
$string['event:postdeleted'] = 'Message effacé';
$string['event:postundeleted'] = 'Message restauré';
$string['event:postupdated'] = 'Message modifié';
$string['event:postreported'] = 'Message signalé';
$string['event:postsplit'] = 'Message scindé';
$string['event:savefailed'] = 'Session échouée lors de la sauvegarde du message';
$string['event:subscriptioncreated'] = 'Abonnement créé';
$string['event:subscriptiondeleted'] = 'Abonnement annulé';

$string['replytouser'] = 'Utiliser l\'adresse de l\'auteur dans le champ "Répondre à"';
$string['configreplytouser'] = 'Lorsqu\'un message est envoyé par e-mail, doit-il contenir l\'adresse e-mail de son auteur, afin que le destinataire puisse l\'atteindre personnellement. Même lorsque cette option est activée, les utilisateurs peuvent choisir dans leur profil de garder leur adresse secrète.';
...
<p>Si vous souhaitez modifier vos préférences de notification, rendez-vous dans la section <span class="txt18BNoir">préférences</span> de votre compte : {$a->userprefs}</p>';
...
$string['forumsubscription'] = 'Abonnement au forum';
$string['discussionoptions'] = 'Options de la discussion';
$string['forum'] = 'Forum';
$string['subscribed'] = 'Abonné';
$string['subscribegroup'] = 'S\'abonner au forum de ce groupe';
$string['subscribeshort'] = 'S\'abonner';
$string['subscribelong'] = 'S\'abonner à tout le forum';
$string['unsubscribegroup'] = 'Se désabonner du forum de ce groupe';
...
$string['subscribestart'] = 'M\'envoyer des copies par e-mail des messages de ce forum';
$string['subscribestop'] = 'Je ne veux pas de copies par e-mail des messages de ce forum';
...
$string['noguestsubscribe'] = 'Désolé, les visiteurs ne sont pas autorisés à s\'abonner pour recevoir les messages des forums par e-mail.';
...
$string['markdiscussionread'] = 'Marquer tous les messages de ce fil de discussion comme lus.';
...
$string['forumng:viewrating'] = 'Voir les évaluations de ses propres messages';
$string['forumng:viewsubscribers'] = 'Voir les abonnés';
$string['forumng:copydiscussion'] = 'Copier la discussion';
$string['forumng:forwardposts'] = 'Transférer le(s) message(s) par e-mail';
$string['forumng:postasmoderator'] = 'S\'dentifier comme modérateur dans le message';
$string['forumng:postanon'] = 'Poster en tant que modérateur anonyme';
$string['forumng:addtag'] = 'Autoriser les utilisateurs à tagger les discussions';
...
$string['configsubscription'] = 'Configuration des options de notification par e-mail sur tous les forums du site.';
...
$string['usebcc']='Envoyer un e-mail en copie invisible (\'Cci\')';
$string['configusebcc']='Laisser cette valeur à 0 pour utiliser les réglages par défaut de la messagerie Moodle (plus sûr).<br>Indiquez un chiffre (par exemple 50) pour regrouper les messages du forum avec l\'option \'copie invisible\' (\'Cci\') pour que Moodle envoie un e-mail unique depuis votre serveur de messagerie à de nombreux utilisateur.<br>Au lieu d\'envoyer 50 fois 1 message aux 50 personnes, cela envoie 1 message aux 50 personnes en copie invisible.';
$string['donotmailafter']='Ne pas envoyer de e-mail après (heure(s))';
$string['configdonotmailafter']='Pour éviter l\'envoi d\'un nombre trop important de messages si le cron de maintenance n\'a pas été exécuté récemment, le forum n\'enverra pas les e-mails correspondants aux messages plus vieux que ce nombre d\'heures.';
$string['re']='Re: {$a}';
...
$string['alt_discussion_moderator'] = 'Discussion modifiée par un modérateur';
$string['subscribestate_partiallysubscribed'] = 'Vous recevez des messages provenant de certaines discussions de ce forum par e-mail à {$a}.';
$string['subscribestate_partiallysubscribed_thisgroup'] = 'Vous recevez des messages provenant de certaines discussions de ce groupe  par e-mail à {$a}.';
$string['subscribestate_groups_partiallysubscribed'] = 'Vous recevez des messages provenant de certains groupes de ce forum par e-mail à {$a}.';
$string['subscribestate_subscribed'] = 'Vous recevez des messages de ce forum par e-mail à {$a}.';
$string['subscribestate_subscribed_thisgroup'] = 'Vous recevez des messages de ce groupe par e-mail à {$a}.';
$string['subscribestate_subscribed_notinallgroup'] = 'Cliquer sur &lsquo;Désabonnement&rsquo; pour se désabonner de ce forum.';
$string['subscribestate_unsubscribed'] = 'Vous ne recevez pas les messages de ce forum par e-mail. Si vous le souhaitez, cliquez sur &lsquo;S\'abonner&rsquo;.';
$string['subscribestate_unsubscribed_thisgroup'] = 'Vous ne recevez pas les messages de ce groupe par e-mail. Si vous le souhaitez, cliquez sur &lsquo;S\'abonner&rsquo;';
$string['subscribestate_not_permitted'] = 'Ce forum ne permet pas l\'abonnement par e-mail.';
$string['subscribestate_forced'] = '(Le désabonnement n\'est pas possible.)';
$string['subscribestate_no_access'] = 'Vous n\'avez pas la possibilité de vous abonner par e-mail à ce forum.';
$string['subscribestate_discussionsubscribed'] = 'Vous recevez tous les messages de cette discussion par e-mail à {$a}.';
$string['subscribestate_discussionunsubscribed'] = 'Vous ne recevez pas les messages de cette discussion par e-mail. Si vous le souhaitez, cliquez sur &lsquo;S\'abonner&rsquo;.';
$string['subscribestate_info'] = 'Vos préférences de courriel{$a}:';
$string['subscribestate_info_link'] = 'changé';
...
$string['expand_text'] = 'Développer le message';
...
$string['confirmdeletediscuss'] = 'Supprimer la discussion';
...
$string['deleteandemail'] = 'Supprimer et notifier l\'auteur par e-mail';
...
$string['emailerror'] = 'Il y a eu une erreur lors de l\envoi de l\'e-mail';
...
$string['forumng:mailnow'] = 'Notifier par e-mail avant la fin du délai d\'édition';
...
$string['flaggeddiscussions'] = 'Discussions marquées';
$string['flaggeddiscussionslink'] = '{$a} discussion(s) marquée(s) comme Importante(s)';
$string['flaggedposts'] = 'Messages marqués';
$string['flaggedpostslink'] = '{$a} message(s) marqué(s) comme Important(s)';
$string['post'] = 'Message';
$string['author'] = 'Auteur';
$string['clearflag'] = 'Retirer le marqueur';
$string['flagpost'] = 'Message marqué';
...
$string['markpostread'] = 'Marquer le message comme lu';
...
<ul>
<li>les anciens forums convertis seront cachés durant l\'exécution du processus de conversion. Cela vous garantit qu\'aucun nouveau message ne soit publié et \'exclu\' de la conversion</li>
...
$string['reply_readonly'] = 'Ce forum est en lecture seule, aucune réponse ne peut être ajoutée.';
...
$string['error_forwardemail'] = 'Il y a eu une erreur lors de l\'envoi de l\'e-mail à  <strong>{$a}</strong>. L\'e-mail n\'a pu être envoyé.';
$string['alert_link'] = 'Signaler';
$string['alert_linktitle'] = 'Marquer ce message comme inacceptable';
$string['reportunacceptable'] = 'E-mail de contact pour le signalement de messages offensants';
$string['reportingemail'] = 'E-mail de contact pour le signalement de messages offensants';
...
$string['alert_note'] = 'Note : Cet e-mail a également été envoyé à {$a}';
...
Vous pouvez sélectionner n\'importe quel forum du même espace de cours.</li></ul>';
...
$string['error_ratingrequired'] = 'L\'évaluation choisie est basée sur les notes, mais la notation n\'est pas activée.';
...
$string['authorname_help'] = 'Vous pouvez taper un prénom (Michel), un nom de famille (Dupont), le nom complet (Michel Dupont), ou la première partie de l\'un de ces éléments (Mic, dup, Michel D). La recherche est insensible à la casse.
...
$string['mailnow_help'] = 'Envoyer votre message par e-mail aux abonnés plus rapidement.

Sauf si vous choisissez cette option, le système attend pendant un certain temps avant d\'envoyer le message de telle sorte que toutes les modifications que vous pourriez faire peuvent être inclus dans l\'e-mail.';
...
$string['flaggeddiscussions_help'] = 'Les discussions marquées apparaissent dans cette liste. Pour voir une discussion marquée, cliquez dessus.

Pour supprimer le marquage d\'une discussion, cliquez sur l\'icone de marquage (ici ou sur le bouton \'Retirer le marqueur\' dans la discussion).';
...
$string['anonymousmoderator'] = 'Modérateur anonyme';
$string['canpostanon'] = 'Autoriser la modération anonyme des messages';
$string['canpostanon_help'] = 'Autoriser les utilisateurs qui peuvent poster anonymement à faire leurs post anonyme en cachant leur nom aux étudiants.';
$string['asmoderator'] = 'Poster en tant que ?';
$string['asmoderator_post'] = 'Message standard';
$string['asmoderator_self'] = 'S\'identifier en tant que modérateur';
$string['asmoderator_anon'] = 'S\'identifier en tant que modérateur (nom caché aux étudiants)';
$string['asmoderator_help'] = 'Cette option permettra à certains utilisateurs de s\'identifier comme un modérateur du forum tout en cachant leur profil aux étudiants.';
$string['createdbymoderator'] = 'Ce message a été créé par le modérateur {$a} avec son nom caché aux étudiants.';
...
$string['extra_emails'] = 'Adresse e-mail des autres destinataires';
...
$string['emailauthor'] = 'Auteur de l\'e-mail';
...
$string['emailauthor_help'] = 'Envoyer un e-mail à l’auteur du message pour l\'informer que vous avez modifié son message';
$string['editedforumpost'] = 'Votre message a été modifié';

$string['postedasmoderator'] = 'Posté en tant que modérateur';
$string['postedasmoderator_help'] = 'Rechercher les messages qui ont été identifiés comme créés par un modérateur';

$string['savefailtitle'] = 'La sauvegarde du message a échoué';
...
Pour conserver vos modifications vous devez copier le contenu du message, accéder à nouveau à cette page, puis coller le contenu.</p>';
$string['tagging'] = 'Ajout de tags';
$string['enabletagging'] = 'Autoriser l\'ajout de tags sur les discussions';
$string['tagging_help'] = 'Autoriser l\'ajout de tags sur les discussions pour ce forum et autoriser également l\'activation des tags globaux du forum';
$string['discussiontags'] = 'Tags de discussion';
$string['discussiontags_help'] = 'Pour ajouter des tags sur une discussion, entrez les tags séparés par des virgules';
$string['forumngdiscusstagfilter'] = 'Afficher les discussions du forum par tag';
$string['forumngdiscusstagfilter_help'] = 'Choisir un tag pour filtrer l\'affichage des discussions';
$string['removefiltering'] = ' Affichage des discussions avec le tag \'{$a}\'';
$string['filterdiscussions'] = 'Afficher les discussions avec le tag';
$string['remove'] = 'Supprimer';
$string['show_all'] = 'Afficher tout';
$string['settags'] = 'Définir les tags de la discussion';
$string['settags_help'] = 'Entrer un \'Jeu\' de tags globaux du forum à utiliser dans les discussions, en saisissant des tags séparés par des virgules';
$string['settag_label'] = 'Jeu';
$string['setforumtags'] = 'Jeu de tags globaux du forum';
$string['noratings'] = 'Pas de note';
$string['forumngratingsobsolete'] = 'Notes Forumng (obsolète)';
$string['standardratings'] = 'Note (standard)';
$string['forumng:viewallratings'] = 'Voir toutes les notes brutes données par des utilisateurs';
$string['forumngcrontaskemails'] = 'Tâche d\'envoi d\'e-mail de Forumng';
$string['forumngcrontaskdaily'] = 'Tâche de maintenance quotidienne de Forumng';
$string['forumngcrontaskdigest'] = 'Tâche de génération de l\'e-mail de synthèse de Forumng';
