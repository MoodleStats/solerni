YUI.add('moodle-theme_solerni-coloursswitcher', function (Y) {
...
// Available color schemes.
     ...
     * Initialise this class by calling M.theme_solerni.init
     */
    ...
    ColoursSwitcher.prototype = {
        ...
        setScheme: function (e, scheme) {
            ...
            M.util.set_user_preference('theme_solerni_colours', scheme);
        }
    };
...
// Our Essential theme namespace
    M.theme_solerni = M.theme_solerni || {};
// Initialisation function for the colours scheme switcher
    M.theme_solerni.initColoursSwitcher = function (cfg) {
