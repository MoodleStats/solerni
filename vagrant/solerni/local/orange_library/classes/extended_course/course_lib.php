...
function is_closed($extendedcourse) {
    ...
    if ($extendedcourse->enddate == 0) {
        $return = false;
    } else if (utilities_object::is_after($extendedcourse->enddate)) {
        $return = true;
    }
    return $return;
}
...
/**
 * Return mooc state when is running.
 *
 * @param object $extendedcourse
...
/**
 * Return mooc state when is closed.
 *
 * @param object $extendedcourse
 * @return object $extendedcourse
 */
...
/**
 * Return mooc state when is not started.
 *
 * @param object $extendedcourse
 * @return object $extendedcourse
 */
