/**
 * Gruntfile for compiling theme_solerni .less files.
 *
 ...
 * Porcelain tasks:
 * ----------------
 * The nice user interface intended for e   veryday use. Provide a
...
module.exports = function(grunt) {
    ...
    decachephp = '../../../moodle/admin/cli/purge_caches.php';
    ...
    grunt.initConfig({
        less: {
            ...
            solerni_p: {
                ...
                src: 'less/solerni.less',
                dest: 'style/solerni.css'
            },
            editor_p: {
                options: {
                    compress: false,
