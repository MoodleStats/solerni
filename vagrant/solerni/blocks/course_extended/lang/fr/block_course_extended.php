...
$string['course_extended:addinstance'] = 'Ajout d\'un nouveau bloc données étendues du cours';
$string['course_extended:myaddinstance'] = 'Ajout d\'un nouveau bloc données étendues du cours à la page Mon Moodle';
