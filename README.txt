...
http://moodle.org/plugins/view.php?plugin=theme_solerni
and
https://github.com/gjb2048/moodle-theme_solerni/releases
...
https://github.com/gjb2048/moodle-theme_solerni and doing a 'Pull Request' so that the rest of the
...
6.  In the database, remove the row with the 'plugin' of 'theme_solerni' and 'name' of 'version' in the 'config_plugins' table, then
...
It has been removed because of licencing issues: https://github.com/gjb2048/moodle-theme_solerni/issues/61
...
or check the issue list https://github.com/gjb2048/moodle-theme_solerni/issues and if the problem does not exist, create an
issue.
...
- FIX: Issue #356: Incorrect $filename in /pluginfile.php/1/theme_solerni/style/<timestamp>/essential.css.
...
- Now has a companion Mahara ePorfolio theme so you can keep them looking alike - https://github.com/moodleman/mahara-theme_solerni
...
If you have questions you can post them in the issue tracker at https://github.com/gjb2048/moodle-theme_solerni/issues