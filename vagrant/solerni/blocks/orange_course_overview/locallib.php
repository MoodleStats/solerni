 ...
 */
function block_orange_course_overview_get_overviews($courses) {
    $htmlarray = array();
 ...
 */
function block_orange_course_overview_update_mynumber($number) {
 ...
 */
function block_orange_course_overview_update_myorder($sortorder) {
 ...
 */
function block_orange_course_overview_get_myorder() {
    ...
    if ($value = get_user_preferences('course_overview_course_order')) {
        ...
        block_orange_course_overview_update_myorder($order);
 ...
 */
function block_orange_course_overview_get_child_shortnames($courseid) {
    global $DB;
    ...
    if ($results = $DB->get_records_sql($sql, $params)) {
        ...
        if ($total > 10) {
            ...
            if ($diff > 1) {
                $suffix = get_string('shortnamesufixprural', 'block_orange_course_overview', $diff);
            } else {
                $suffix = get_string('shortnamesufixsingular', 'block_orange_course_overview', $diff);
            }
        }
 ...
 */
function block_orange_course_overview_get_max_user_courses($showallcourses = false) {
 ...
 */
function block_orange_course_overview_get_sorted_courses($showallcourses = false) {
    global $USER;

    $limit = block_orange_course_overview_get_max_user_courses($showallcourses);
    ...
    $order = block_orange_course_overview_get_myorder();
