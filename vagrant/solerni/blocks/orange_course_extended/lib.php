...
function block_orange_course_extended_print_page($courseextended, $return = false) {
    global $OUTPUT;
...
function block_orange_course_extended_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options=array()) {
    ...
    $file = $fs->get_file($context->id, 'block_orange_course_extended', $filearea, $itemid, $filepath, $filename);
    if (!$file) {
        return false;
    }
