 ...
 */
class MoodleQuickForm_helpblock extends HTML_QuickForm_static{
    /** @var string Form element type */
    var $_elementTemplateType='helpblock';
     ...
     */
    function MoodleQuickForm_helpblock($elementName=null, $elementLabel=null, $text=null) {
