...
$string['choosereadme']             = 'Orange Solerni Theme. Built from Bootstrap3 / Cerulean : https://github.com/bmbrands/theme_bootstrap';
...
$string['frontpagepresentation']        = 'Texte d\'entête';
...
$string['colourheadingdesc']            = '<p>Cette page permet de modifier et de regénérer les fichers CSS du thème basé sur Bootstrap. Cela nécessite une compréhension au minimum basique de la façon dont s\'articule la correspondance entre chaque couleur et chaque variable, et entre chaque variable et les éléments de l\'interface. Pour annuler un changement et restaurer la valeur par défaut, il suffit de supprimer la valeur dans le champ de saisie de la variable concernée et de sauvegarder.</p>';
$string['body_bg']                      = '@body-bg';
$string['body_bgdesc']                  = '';
$string['brand_primary']                = '@brand-primary';
$string['brand_primarydesc']            = '';
$string['brand_secondary']              = '@brand-secondary';
...
$string['brand_infodesc']               = '';
$string['brand_warning']                = '@brand-warning';
$string['brand_warningdesc']            = '';
$string['brand_danger']                 = '@brand-danger';
$string['brand_dangerdesc']             = '';
$string['orange_yellow']                = '@orange-yellow';
$string['orange_yellowdesc']            = '';
$string['orange_blue']                  = '@oange-blue';
$string['orange_bluedesc']              = '';
$string['orange_green']                 = '@orange-green';
$string['orange_greendesc']             = '';
$string['orange_purple']                = '@orange-purple';
