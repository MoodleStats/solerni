...
$string['analyticssiteurldesc'] = 'Entrez l\'URL de votre "Piwik Analytics" sans http(s) ou la barre oblique finale. Par exemple "monsite.com/analytics".';
...
$string['analyticstrackingid'] = 'ID du site';
...
$string['logowidthdesc'] = 'La largeur du logo. Elle peut être définie en px (pixel) ou em (cadratin).';
