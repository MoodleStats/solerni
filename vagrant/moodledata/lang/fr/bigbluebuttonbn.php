...
/**
 * Strings for component 'bigbluebuttonbn', language 'fr', branch 'MOODLE_29_STABLE'
 *
...
$string['config_feature_preuploadpresentation_description'] = 'Ces paramètres activent ou désactivent les options de l\'interface utilisateur et définissent également les valeurs par défaut de ces options.';
