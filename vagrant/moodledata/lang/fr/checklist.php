...
Remarque : cela peut prendre jusqu\'à 60 secondes pour que l\'activité d\'un étudiant se mette à jour dans leur Checklist';
$string['autoupdatenote'] = 'Si le choix « étudiant » pour la modification automatique est coché, les mises à jour ne seront pas affichées dans les Checklists pour « Enseignant seul »';
...
$string['checkeditemsdeleted'] = 'Éléments de la Checklist supprimés';
$string['checklist'] = 'Checklist';
$string['checklist:addinstance'] = 'Ajouter une nouvelle Checklist';
$string['checklistautoupdate'] = 'Autoriser les Checklists à être modifiées automatiquement';
$string['checklist:edit'] = 'Créer et éditer des Checklists';
...
$string['configshowmymoodle'] = 'Si ce réglage n\'est pas activé, l\'activité Checklist (avec des barres de progression) ne sera plus affichées dans « Ma page »';
$string['configshowupdateablemymoodle'] = 'Si cette case est cochée, seules les listes modifiables seront affichées dans « Ma Page »';
$string['confirmdeleteitem'] = 'Êtes-vous sûr de vouloir effacer définitivement cet élément de la Checklist ?';
...
$string['emailoncompletebody'] = 'L\'utilisateur {$a->user} a complété sa Checklist « {$a->checklist} »
...
$string['emailoncompletesubject'] = 'L\'utilisateur {$a->user} a complété sa Checklist « {$a->checklist} »';
$string['emailoncompletesubjectown'] = 'Vous avez terminé la Checklist « {$a->checklist} »';
$string['eventchecklistcomplete'] = 'Checklist complète';
...
$string['guestsno'] = 'Vous n\'avez pas l\'autorisation de voir cette Checklist';
...
$string['items'] = 'Éléments de la Checklist';
...
$string['modulename_help'] = 'L\'activité ­« Checklist » permet aux enseignants de créer des listes de tâches pour le suivi des étudiants.';
$string['modulenameplural'] = 'Checklists';
$string['moveitemdown'] = 'Descendre l\'item';
$string['moveitemup'] = 'Monter l\'item';
$string['noitems'] = 'Pas d\'éléments dans la Checklist';
...
$string['showcompletemymoodle'] = 'Afficher les Checklists terminées dans « Ma page »';
$string['showfulldetails'] = 'Afficher tous les détails';
$string['showmymoodle'] = 'Afficher les Checklists dans « Ma page »';
$string['showprogressbars'] = 'Afficher les barres de progression';
$string['showupdateablemymoodle'] = 'Afficher uniquement les Checklist modifiables dans « Ma Page »';
