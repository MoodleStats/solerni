...
/**
 * Strings for component 'block_massaction', language 'fr', branch 'MOODLE_29_STABLE'
 *
...
$string['action_moveleft'] = 'Diminuer le retrait (déplacer vers la gauche)';
$string['action_moveright'] = 'Faire un retrait (déplacement vers la droite)';
...
$string['deletecheck'] = 'Confirmer la suppression en lot';
$string['deletecheckconfirm'] = 'Voulez-vous VRAIMENT supprimer l(es) élément(s) suivant(s) ?';
$string['deletecheckpreconfirm'] = 'Voulez-vous vraiment supprimer l(es) élément(s) suivant(s) ?';
...
$string['invalidcoursemodule'] = 'Élément de cours invalide';
