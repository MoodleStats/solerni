 ...
 */
class block_course_essentials extends block_base {

    /**
     * Initializes the block, called by the constructor
     */
    public function init() {
        $this->title = get_string('pluginname', 'block_course_essentials');
    }
    ...
    public function specialization() {
        if (!empty($this->config->blocktitle)) {
            ...
            $this->title = get_string('config_blocktitle_default', 'block_course_essentials');
        }
    }
    ...
    public function get_content() {
        ...
        if (!$format->uses_sections()) {
            if (debugging()) {
                $this->content->text = get_string('notusingsections', 'block_course_essentials');
            }
            return $this->content;
        }
