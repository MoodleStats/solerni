...
/**
 * Strings for component 'hsuforum', language 'fr', branch 'MOODLE_28_STABLE'
 *
 * @package   hsuforum
...
$string['anonymouswarning'] = 'En déplaçant ce sujet de discussion vous pourriez révéler des informations sur les contributeurs anonymes. Êtes vous sûr de vouloir faire cela ?';
...
$string['configtrackingtype'] = 'Paramètre par défaut pour le suivi des messages lus';
...
$string['deletesureplural'] = 'Êtes-vous sûr de vouloir supprimer ce message et toutes ses réponses ? ({$a} posts)';
...
$string['hideadvancededitor'] = 'Cacher l\'éditeur de texte avancé';
...
$string['loadingeditor'] = 'Chargement de l\'éditeur';
...
$string['manualwarning'] = 'L\'évaluation n\'est pas encore supportée. L\'évaluation est uniquement disponible depuis le carnet de note du cours.';
...
$string['postmailinfo'] = 'Ceci est une copie';
...
$string['trackingoff'] = 'Arrêt';
$string['trackingon'] = 'Forcé';
$string['trackingoptional'] = 'Optionnel';
$string['trackingoptions'] = 'Options de suivi';
$string['trackingtype'] = 'Voir le suivi pour ce forum ?';
$string['trackingtype_help'] = 'SI activé, les participants pourront suivre les messages lus ou non dans le forum et ses discussions. Il existe trois options :

* Optionnel : les participants peuvent choisir s\'ils veulent activer ou non le suivi via un lien dans le bloc administration. Le suivi des forums doit par ailleurs être activé dans les paramètres du profil utilisateur ;
* Forcé : le suivi est toujours activé, quels que soient les réglages de l\'utilisateur. Option disponible en fonction des paramètres administratif ;
* Arrêt : les messages lus ou non ne sont pas suivis.';
$string['tree'] = 'Arbre';
