...
function theme_solerni_analytics_trackurl()
{
    global $DB, $PAGE;
...
function theme_solerni_insert_analytics_tracking()
{
    $siteurl = theme_solerni_get_setting('analyticssiteurl');
    $tracking = '';

    if (!empty($siteurl)) {
        $imagetrack = theme_solerni_get_setting('analyticsimagetrack');
        $siteid = theme_solerni_get_setting('analyticssiteid');
        $trackadmin = theme_solerni_get_setting('analyticstrackadmin');
        $cleanurl = theme_solerni_get_setting('analyticscleanurl');
        ...
        if ($cleanurl) {
            $doctitle = "_paq.push(['setDocumentTitle', " . theme_solerni_analytics_trackurl() . "]);";
        } else {
            $doctitle = "";
        }
...
echo theme_solerni_insert_analytics_tracking();