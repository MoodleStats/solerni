 ...
 * Version details
 *
 * @package    local_orange_event_course_createded
...
if (isset($instance->id)) {
    ...
    if (($course != null) && ($enroldata != null) && ((time() - $enroldata->timecreated) < 5) ) {
        ...
        if ($course[$id]->startdate <= time()) {
            $message = get_string('welcome_enrolment_message_title', 'local_orange_event_course_created') . " " .
                get_string('welcome_enrolment_message_inscription', 'local_orange_event_course_created',
                format_string($course[$id]->fullname)) . " " .
                get_string('welcome_enrolment_message_started', 'local_orange_event_course_created');
        } else {
            $message = get_string('welcome_enrolment_message_title', 'local_orange_event_course_created') . " " .
                get_string('welcome_enrolment_message_inscription', 'local_orange_event_course_created',
                format_string($course[$id]->fullname)) . " " .
                get_string('welcome_enrolment_message_notstarted', 'local_orange_event_course_created',
