...
class theme_solerni_core_course_renderer extends core_course_renderer
{
    ...
    protected function coursecat_category(coursecat_helper $chelper, $coursecat, $depth)
    {
        ...
        if (theme_solerni_get_setting('enablecategoryicon')) {
            if (theme_solerni_get_setting($categoryiconnum) &&
                theme_solerni_get_setting('enablecustomcategoryicon')
            ) {
                // User has set a value for the category
                $val = theme_solerni_get_setting($categoryiconnum);
            } else {
                // User hasn't set a value for the category, get the default
                $val = theme_solerni_get_setting('defaultcategoryicon');
            }
        }
        if (!empty($val)) {
    ...
    protected function coursecat_coursebox_content(coursecat_helper $chelper, $course) {
        ...
        if ($coursehascontacts) {
            ...
            foreach ($course->get_course_contacts() as $userid => $coursecontact) {
                $faiconsetting = theme_solerni_get_setting('courselistteachericon');
