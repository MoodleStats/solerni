...
function main () {
	...
	# By default on solerni.fr no access on mail feature  (#us_529)
	execute_moosh_command "moosh role-update-capability solerni_utilisateur moodle/site:sendmessage prevent 1"
}
