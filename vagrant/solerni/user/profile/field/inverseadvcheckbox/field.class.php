...
/**
 * Class profile_field_inverseadvcheckbox
 *
 * @copyright  2008 onwards Shane Elliot {@link http://pukunui.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class profile_field_inverseadvcheckbox extends profile_field_base {
     ...
     * @param int $userid
     */
    public function profile_field_inverseadvcheckbox($fieldid=0, $userid=0) {
        global $DB;
    ...
    public function edit_field_add($mform) {
        ...
        $checkbox = $mform->addElement('inverseadvcheckbox', $this->inputname, format_string($this->field->name));
        if ($this->data == '1') {
