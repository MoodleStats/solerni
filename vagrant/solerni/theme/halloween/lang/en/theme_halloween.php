...
$string['colourheadingdesc']            = 'This will change and generate new CSS Bootstrap-based files. This requires some understand about how Bootstrap variables names are used and mapped to IHM component. To revert any change, erase field content and save to restore default value. Each color setting name is mapped to the corresponding LESS/Bootstrap variable name.';
...
$string['loginheadingdesc']         = 'The upper part of the login page allows for editorial modifications (logo, title, text area). Your can change the default settings here. To remove an item, just remove the content from the field before saving.';
