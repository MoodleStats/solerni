...
/**
 * Strings for component 'qtype_combined', language 'fr', branch 'MOODLE_29_STABLE'
 *
...
$string['err_accepts_vertical_or_horizontal_layout_param'] = '<p>Le \'{$a}\' type de question vous permet de préciser la mise en page de votre type de question comme suit :<ul>
