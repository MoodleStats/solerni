...
$PAGE->set_url('/mod/descriptionpage/index.php', array('id' => $course->id));
$PAGE->set_title($course->shortname.': '.$strpages);
$PAGE->set_heading($course->fullname);
$PAGE->navbar->add($strpages);
echo $OUTPUT->header();
echo $OUTPUT->heading($strpages);
if (!$pages = get_all_instances_in_course('descriptionpage', $course)) {
...
foreach ($pages as $page) {
    ...
    $table->data[] = array (
        ...
        format_module_intro('descriptionpage', $page, $cm->id));
}
