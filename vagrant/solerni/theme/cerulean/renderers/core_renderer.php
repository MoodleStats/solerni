...
class theme_cerulean_core_renderer extends theme_bootstrap_core_renderer {
     ...
     * @isdummy
     */
    public function cerulean_header_links() {
     ...
     * Echo lang menu
     */
    public function cerulean_lang_menu() {
        return $this->cerulean_render_lang_menu( new custom_menu( null, current_language() ) );
    }
     ...
     * @isdummy
     */
    public function cerulean_user_menu() {
        global $USER, $CFG, $SESSION, $PAGE;
        $localdir = dirname(__FILE__); // we are currently inside cerulean/renderers folder
     ...
     */
    protected function cerulean_render_lang_menu(custom_menu $menu) {
        global $CFG;
     ...
     */
    protected function cerulean_render_lang_menu_item(custom_menu_item $menunode, $level = 0, $menu_title = '' ) {
     ...
     * @return: Footer Column HTML Fragment
     */
    public function cerulean_login_render_form($show_instructions, $frm) {
        global $PAGE, $CFG;
     ...
     * @return: Footer Column HTML Fragment
     */
    public function cerulean_register_render_form($show_instructions, $mform_signup) {
        global $PAGE, $CFG;
