...
/**
 * Strings for component 'ouwiki', language 'fr', branch 'MOODLE_29_STABLE'
 *
 * @package   ouwiki
...
$string['createlinkedwiki_help'] = 'Pendant l\'édition, vous poiuvez faire un lien vers une page qui n\'existe pas encore, comme [[Chiens]]. Enregistrez la page en cours et cliquez sur le lien ‘Chiens’ pour créer la nouvelle page.
...
<p>
Le OU wiki offre différentes options. Voir l\'aide individuelle de chauqe paramètre pour plus d\'information.
</p>';
...
$string['numedits'] = '{$a} modification(s)';
...
$string['showwordcounts'] = 'Afficher le nomre de mots';
...
$string['templatefileexists'] = 'Un modèle \'{$a}\' est déjà utilisé.';
