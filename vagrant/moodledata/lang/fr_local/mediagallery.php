...
$string['assignedit'] = 'FR#Edit assignment';
$string['assignsubmit'] = 'FR#Submit assignment';
$string['assignsubmitted'] = 'FR#Assignment submitted';
...
$string['configmaxbytes'] = 'Taille maximale par défaut des éléments pouvant être ajoutés aux bibliothèque multimédia de ce site';
...
$string['contributable'] = 'FR#Contributable';
$string['contributable_help'] = 'Quand une galerie est FR#contributable, cela permet à d\'autres utilisateurs d\'ajouter du contenu à votre galerie. Ils ne pourront modifier que leurs propres éléments. La créateur de la galerie aura la possibilité de supprimer les éléments de la galerie.';
...
$string['enforcedefaults_help'] = 'Si cette option est activée, les albums seront créés avec les valeurs par défaut définies par le gestionnaire. Ces valeurs ne pourront pas être modifiées.';
...
$string['mediagalleryfieldset'] = 'Exemple de champs personnalisés';
